...
module.exports = class Student {
    ...
    static async changeFirstName(studentId, { newFirstName }) {
        console.log("🚀 ~ file: Student.js ~ line 94 ~ Student ~ changeFirstName ~  newFirstName ", newFirstName)
        console.log("🚀 ~ file: Student.js ~ line 94 ~ Student ~ changeFirstName ~ studentId", studentId)
        ...
        console.log("🚀 ~ file: Student.js ~ line 100 ~ Student ~ changeFirstName ~ rows", rows)
