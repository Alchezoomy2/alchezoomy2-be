...
module.exports = class Meeting {
    ...
    static async refreshMeetingInfo(meetingId, meetingObj) {
        console.log("🚀 ~ file: Meeting.js ~ line 292 ~ Meeting ~ refreshMeetingInfo ~ meetingId, meetingObj", meetingId, meetingObj)
        ...
        console.log("🚀 ~ file: Meeting.js ~ line 316 ~ Meeting ~ refreshMeetingInfo ~ rows", rows);
