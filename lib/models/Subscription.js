...
module.exports = class Subscription {
    ...
    static async insert({ studentEmail, teacherEmail }) {
        ...
        WHERE email = $1
        `, [teacherEmail]);
        console.log("🚀 ~ file: Subscription.js ~ line 22 ~ Subscription ~ insert ~ returnedTeacherRaw", returnedTeacherRaw)
        ...
        `, [studentEmail])
        console.log("🚀 ~ file: Subscription.js ~ line 29 ~ Subscription ~ insert ~ returnedStudentRaw ", returnedStudentRaw)
