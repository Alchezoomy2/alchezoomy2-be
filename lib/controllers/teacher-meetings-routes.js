...
module.exports = Router()
    ...
    .put('/update/:id', ensureTeacherAuth, async (req, res) => {
        ...
        try {
            ...
            console.log("🚀 ~ file: teacher-meetings-routes.js ~ line 76 ~ .put ~ meetingObj", meetingObj)
            const zoomMeetingId = await Meeting.fetchZoomMeetingId(meetingObj.id)

            console.log("🚀 ~ file: teacher-meetings-routes.js ~ line 84 ~ .put ~ zoomMeetingId", zoomMeetingId)
