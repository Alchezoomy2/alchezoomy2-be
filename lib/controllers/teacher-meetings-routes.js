...
module.exports = Router()
    ...
    .post('/refresh/:id', ensureTeacherAuth, async (req, res) => {
        ...
        try {
            ...
            const parsedMeetingObj = parseMeetingObj(currentMeetingObj, teacherInfo);
            console.log("🚀 ~ file: teacher-meetings-routes.js ~ line 121 ~ .get ~ parsedMeetingObj", parsedMeetingObj)

            const updatedMeeting = await Meeting.refreshMeetingInfo(meetingId, parsedMeetingObj);
            console.log("🚀 ~ file: teacher-meetings-routes.js ~ line 120 ~ .get ~  updatedMeeting", updatedMeeting)
