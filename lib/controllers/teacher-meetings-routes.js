...
module.exports = Router()
    ...
    .put('/update/:id', ensureTeacherAuth, async (req, res) => {
        ...
        try {
            ...
            console.log("🚀 ~ file: teacher-meetings-routes.js ~ line 72 ~ .put ~ zoomMeetingId", zoomMeetingId)
            await updateZoomInfo(accessToken, zoomMeetingId, meetingObj.topic);
            console.log("🚀 ~ file: teacher-meetings-routes.js ~ line 74 ~ .put ~ updateZoomInfo", updateZoomInfo)

            const updatedMeetingObj = await Meeting.updateLocally(meetingId, meetingObj);
            console.log("🚀 ~ file: teacher-meetings-routes.js ~ line 77 ~ .put ~ updatedMeetingObj", updatedMeetingObj)
