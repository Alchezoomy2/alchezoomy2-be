...
module.exports = Router()
    ...
    .post('/', ensureTeacherAuth, async (req, res, next) => {
        ...
        try {
            ...
            console.log("🚀 ~ file: teacher-meetings-routes.js ~ line 15 ~ .post ~ returnedMettingArray.meetings.length", returnedMettingArray.meetings.length)
            if (returnedMettingArray.meetings.length > 0) {
