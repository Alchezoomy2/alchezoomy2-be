...
module.exports = Router()
    ...
    .post('/new', async (req, res) => {
        ...
        try {
            ...
            console.log("🚀 ~ file: student-routes.js ~ line 47 ~ .post ~ returnedStudentInfo", returnedStudentInfo)

            attachCookie(res, { email: returnedStudentInfo.student_email, id: returnedStudentInfo.id })
