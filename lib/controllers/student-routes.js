...
module.exports = Router()
    ...
    .post('/new', async (req, res) => {
        ...
        console.log("🚀 ~ file: student-routes.js ~ line 39 ~ .post ~ newStudentInfo", newStudentInfo)
    ...
    .post('/exists/', async (req, res) => {
        try {
            ...
            console.log("🚀 ~ file: student-routes.js ~ line 82 ~ .post ~ studentEmail, teacherEmail ", studentEmail, teacherEmail)



            const student = await Student.findByEmail(studentEmail)
            console.log("🚀 ~ file: student-routes.js ~ line 84 ~ .post ~ student", student)
