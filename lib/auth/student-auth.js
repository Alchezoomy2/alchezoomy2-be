...
module.exports = class studentAuth {
    ...
    static authToken(student) {
        console.log("🚀 ~ file: student-auth.js ~ line 40 ~ studentAuth ~ authToken ~ student", student)

        return jwt.sign({ student }, appSecret, {
            expiresIn: '24h'
        });
    }

    static verifyAuthToken(token) {
        console.log("🚀 ~ file: student-auth.js ~ line 48 ~ studentAuth ~ verifyAuthToken ~ token", token)
