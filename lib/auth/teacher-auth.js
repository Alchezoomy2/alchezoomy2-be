...
module.exports = class teacherAuth {
    ...
    static async authorize({ code }) {
        try {
            ...
            console.log("🚀 ~ file: teacher-auth.js ~ line 19 ~ teacherAuth ~ authorize ~  returnedObject", returnedObject)
            ...
            console.log("🚀 ~ file: teacher-auth.js ~ line 27 ~ teacherAuth ~ authorize ~ returnedTeacherInfo", returnedTeacherInfo)
