...
module.exports = async (meetingObj, accessToken) => {
    ...
    for (let cue of parsedTranscript.cues) {
        ...
        console.log("🚀 ~ file: insertNewTranscript.js ~ line 1 ~ module.exports= ~ cue.start", cue.start)
        ...
        console.log("🚀 ~ file: insertNewTranscript.js ~ line 18 ~ module.exports= ~ parsedTimestamp", parsedTimestamp)
