...
module.exports = async (accessToken, { zoomMeetingId, topic }) => {
    ...
    console.log("🚀 ~ file: updateZoomInfo.js ~ line 12 ~ module.exports= ~ getMeeting ", getMeeting.body)
    ...
    console.log("🚀 ~ file: updateZoomInfo.js ~ line 10 ~ updateZoomInfo ~ zoomResponse", zoomResponse.body)
