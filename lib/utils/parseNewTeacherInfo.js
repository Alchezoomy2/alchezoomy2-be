...
module.exports = async (teacherObj, access_token, refresh_token) => {
    console.log("🚀 ~ file: parseNewTeacherInfo.js ~ line 5 ~ module.exports= ~ teacherObj", teacherObj)
    ...
    console.log("🚀 ~ file: parseNewTeacherInfo.js ~ line 15 ~ module.exports= ~ accountExists", accountExists)
