...
module.exports = async (meeting, user_info) => {
    console.log("🚀 ~ file: parseMeetingObj.js ~ line 5 ~ module.exports= ~ meeting", meeting);
    ...
    console.log("🚀 ~ file: parseMeetingObj.js ~ line 15 ~ module.exports= ~  video_download_url", video_download_url)
    ...
    console.log("🚀 ~ file: parseMeetingObj.js ~ line 49 ~ module.exports= ~  meetingObj", meetingObj)
