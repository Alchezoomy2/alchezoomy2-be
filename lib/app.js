...
app.get('/seed_meetings', async (req, res) => {
  ...
  try {
    ...
    // const oneTranscript = await nfetch(formattedUrls[0]);
    // console.log(formattedUrls[0])
    // console.log(oneTranscript);
    // res.json(oneTranscript)
